package com.venkat.restpoc.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("RESTPoC");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("RESTPoC");
        ...
        config.getMapConfigs().put("com.venkat.restpoc.domain.*", initializeDomainMapConfig(jHipsterProperties));
